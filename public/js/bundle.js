...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // Here we specify a center of a map (Where it should display its default view). Just an example of how it works
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popup (message on each location)
...
var showAlert = function showAlert(type, msg) {
  ...
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); // here we create html for inserting
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You logged in successfully this time!');
              window.setTimeout(function () {
                // allert will be available 1.5 sec
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'FATAL ERROR!!! TRY AGAIN!!!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            // we can use try/catch with axios
            ...
            return (0, _axios.default)({
              ...
              url: url,
              // data which sends with the body (http request)
              data: data // data is object from argument will be sent
          ...
          case 4:
            ...
            // alert shows that log in was successful
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "You changed your ".concat(type.toUpperCase(), " this time!"));
              window.setTimeout(function () {
                // allert will be available 1.5 sec
                location.assign('/'); // load homepage after successful log in
              }, 1500);
...
var stripe = Stripe('pk_test_51H6Nx9DPL1O2BwgVmUBQwEWdBHVDU8ObpcfU4z7NnJ1E1amGlef8FkFo9jFiiing1DcmTVG9zAfAosoDUnNN1d9O00ymDD8DSZ'); // in Stripe('public key') we need our public key
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value; //reads data from #email ID in login.pug
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // e.target - the element which was triggered for this event to be fired (L211)
